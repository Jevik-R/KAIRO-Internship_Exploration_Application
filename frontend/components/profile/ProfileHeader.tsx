      ...
      <div className="px-6 sm:px-8 pb-8 -mt-16 relative">
        <div className="flex flex-col sm:flex-row gap-6 items-start">
          ...
          <div className="flex-1 pt-4">
            ...
            {/* Social Links - Only for applicants */}
            {isApplicant && (hasResume || hasGitHub || hasLinkedIn) && (
            ...
            <div className="space-y-3">
              {isApplicant ? (
                ...
                <p className="text-foreground/80 leading-relaxed text-sm sm:text-base">{recruiter.about}</p>
              ) : (
              ...
              {isOwner && (
                <AddAboutButton
                  ...
                  initialAbout={isApplicant ? applicant?.about : recruiter?.about}
